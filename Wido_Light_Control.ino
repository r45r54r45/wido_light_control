...
#define WLAN_SSID       "iptime"           // cannot be longer than 32 characters!
...
void loop(){
  ...
  if(!tcpClient.connected()){
    ...
    uint32_t ip = WiDo.IP2U32(192,168,0,30);
    tcpClient = WiDo.connectTCP(ip, 4001);
...
//    myservo.write((heartRate/1000)%180);
